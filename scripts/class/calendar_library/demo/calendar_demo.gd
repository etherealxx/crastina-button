...
func _ready() -> void:
	DisplayServer.window_set_size(Vector2i(1300, 700))
...
var locale_path := "res://scripts/class/calendar_library/demo"
...
func _on_language_option_button_item_selected(index: int) -> void:
	match index:
		0:	
			cal.set_calendar_locale(locale_path.path_join("calendar_locale_EN.tres"))
		1:
			cal.set_calendar_locale(locale_path.path_join("calendar_locale_DE.tres"))
		2:
			cal.set_calendar_locale(locale_path.path_join("calendar_locale_ES.tres"))
		3:
			cal.set_calendar_locale(locale_path.path_join("calendar_locale_CN.tres"))
		4:
			cal.set_calendar_locale(locale_path.path_join("calendar_locale_SE.tres"))
